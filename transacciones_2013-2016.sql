...
select load_csv_file('firmas', '/home/claudio/projects/cardestat/transacciones_2013-2016.csv', 22);
...
insert into property (reference, entry_date, active_date, inactive_date, property_type, location, building_complex, geo_coordinates, plot_area_dm2, built_area_dm2, n_bedrooms)
select
    'OB-V11574', '2013-05-01', '2013-05-01', '2013-05-08', 'Apartment', 'Playa del Inglés', 'Ecuador', '27.754808, -15.572702', null, 3464, 1
where not exists (select id from property where reference = 'OB-V11574');

insert into property (reference, entry_date, active_date, inactive_date, property_type, location, building_complex, geo_coordinates, plot_area_dm2, built_area_dm2, n_bedrooms)
select
    'OB-V32483', '2016-05-13', '2016-05-13', '2017-04-03', 'Duplex', 'Meloneras', null, '27.754808, -15.572702', null, 8990, 2
where not exists (select id from property where reference = 'OB-V32483');
