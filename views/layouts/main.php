    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => \Yii::t('app', 'Charts'), 'active' => Yii::$app->controller->id == 'chart', 'items' => [
                ...
                ['label' => \Yii::t('app', 'Attributions by advisor'), 'url' => ['/chart/attribution-by-advisor']],
                ['label' => \Yii::t('app', 'Attributions by office'), 'url' => ['/chart/attribution-by-office']],
                ['label' => Yii::t('app', 'Prorated operations'), 'options' => ['class' => 'dropdown-header']],
                ['label' => \Yii::t('app', 'P.r. Operations by advisor'), 'url' => ['/chart/pr-operation-by-advisor']],
                ['label' => \Yii::t('app', 'P.r. Operations by office'), 'url' => ['/chart/pr-operation-by-office']],
                ['label' => Yii::t('app', 'Ratios'), 'options' => ['class' => 'dropdown-header']],
                ['label' => \Yii::t('app', 'Attributions/Operation by advisor'), 'url' => ['/chart/attribution-over-operation-by-advisor']],
                ['label' => \Yii::t('app', 'Attributions/Operation by office'), 'url' => ['/chart/attribution-over-operation-by-office']],
                ['label' => Yii::t('app', 'Trading volume'), 'options' => ['class' => 'dropdown-header']],
                ['label' => \Yii::t('app', 'Transactions vs. Revenue'), 'url' => ['/chart/volume']],
                ['label' => \Yii::t('app', 'Transactions vs. Revenue Avg.'), 'url' => ['/chart/avg-volume']],
            ]],
